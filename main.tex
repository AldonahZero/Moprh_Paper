...
Taken together, these systems span query migration (SQLGlot, jOOQ), LLM-assisted dialect translation (CrackSQL), dialect-aware rule reduction (RISE), and metamorphic-oracle portability (QTRAN), yet none of them targets fuzzing-oriented seed construction. Their translation units remain individual statements or queries rather than complete test cases, and they do not explicitly model the cross-statement dependencies, evolving schema context, or fuzzer-grammar compatibility that whole-test-case seed transfer requires. \tool{} is designed specifically to fill this gap.
