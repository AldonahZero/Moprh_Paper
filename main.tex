...
Overall, these systems improve query migration, semantic-equivalent translation, or oracle portability, but their goal is not dependency-preserving test-case-level seed transfer.

RISE~\cite{xie2026rise} is the closest comparison for this gap, because its dialect-aware query reduction also separates dialect-specific elements from surrounding SQL.
