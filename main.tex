...
Reference, type, and state errors rise from 6.8\%, 8.2\%, and 2.6\% to 19.5\%, 14.5\%, and 8.4\%, respectively, showing that executable test-case transfer requires propagating schema, type, and state context across statements.
