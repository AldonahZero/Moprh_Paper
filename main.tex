...
\begin{figure*}[t]
  ...
  (2) Dialect-Aware AQT Instantiation. 
  \tool{} uses a task planner to decompose test case transformations and instantiates AQT nodes by retrieving dialect evidence from a hybrid knowledge base, invoking the LLM only for bounded rule generation and local error correction.
