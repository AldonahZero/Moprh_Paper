...
However, existing SQL dialect translation methods primarily target statement-level SQL translation and struggle to handle entire test cases containing interdependent DDL, DML, and DQL statements.
