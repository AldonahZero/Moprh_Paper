...
Recent fuzzing-oriented methods employ LLMs to perform end-to-end transfer across DBMSs. Nevertheless, without explicit modeling of test-case structure and dialect constraints, such approaches often introduce syntactic errors, semantic inconsistencies, and fuzzer-incompatible outputs.
