...
\end{table}
The entries marked \partmark indicate restricted, fragment-level support: such tools may translate isolated DDL, DML, or DQL fragments, but they do not support ordered DDL--DML--DQL seed migration where earlier schema, data, or object-state changes must be preserved for later statements and the migrated sequence must remain parsable and mutable by a downstream fuzzer.
