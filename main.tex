...
For example, on DuckDB, SQLGlot, CrackSQL, and RISE achieve syntactic correctness above 0.738, yet their semantic correctness remains no higher than 0.314.
Although \sedar{} improves semantic correctness over these generic translators on most targets, it still suffers from semantic hallucinations and destructive sanitization. 
...
\begin{table}[ht]
\centering % <--- 关键：居中对齐
\caption{Comparison of syntactic and semantic correctness across target DBMSs. Syn. and Sem. denote syntactic correctness and semantic correctness, respectively. The best result in each column is highlighted in bold. The last row reports the relative improvement of \tool{} over \sedar{}.}
...
\resizebox{\columnwidth}{!}{%
    \begin{tabular}{l|cc|cc|cc|cc}
        ...
        SQLGlot & 0.640 & 0.244 & 0.480 & 0.091 & 0.738 & 0.186 & 0.665 & 0.193 \\
        jOOQ & 0.571 & 0.115 & 0.382 & 0.072 & 0.652 & 0.136 & 0.554 & 0.175 \\
        CrackSQL & 0.757 & 0.199 & 0.537 & 0.159 & 0.740 & 0.211 & 0.717 & 0.264 \\
...
As summarized in Table~\ref{tab:diversity}, \tool{} demonstrates a consistent ability to maintain a higher degree of semantic richness than all baselines. 
...
\begin{table}[ht]
\centering % <--- 让表格居中
\caption{Statistics of valid SQL features in the transferred seeds. F, DT, and K denote functions, data types, and keywords, respectively. The best result in each column is highlighted in bold. The last row reports percentage improvement of \tool{} over \sedar{}.}
\label{tab:diversity}
{\footnotesize
...
\begin{tabular}{@{}l|ccc|ccc|ccc|ccc@{}}
    ...
    SQLGlot & 113 & 25 & 231 & 32 & 15 & 107 & 195 & 28 & 288 & 103 & 35 & 142 \\
    jOOQ & 110 & 17 & 210 & 34 & 14 & 103 & 187 & 22 & 253 & 94 & 34 & 104 \\
    CrackSQL & 133 & 23 & 255 & 41 & 17 & 108 & 198 & 32 & 329 & 146 & 46 & 136 \\
...
To extend \tool{} to other DBMSs, we mine lexical/syntactic rules from grammar resources and register them into the Hybrid KB. New rules are generated only when retrieval confidence is low and then cached, making extension incremental.
