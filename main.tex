...
To ensure syntactic correctness under semantic constraints, each generated fragment is validated by the target database parser. If a parsing error occurs, an iterative repair loop repairs the fragment and its rule using the error message and structural context while preserving semantic intent (Line~\ref{line:alg2:fix}). Only successfully validated rules are cached; unverified rules are discarded. This mechanism avoids degenerate fixes such as clause removal and enforces faithful preservation of query semantics.
...
For example, on DuckDB, SQLGlot, CrackSQL, and RISE achieve syntactic correctness above 0.738, yet their semantic validity remains no higher than 0.314.
Although \sedar{} improves semantic validity over these generic translators on most targets, it still suffers from semantic hallucinations and destructive sanitization. 
In contrast, \tool{} achieves the best result in every syntactic and semantic column, with \synatxratio{} higher syntactic correctness and \translateratio{} higher semantic correctness than \sedar{} on the tested DBMSs.
On \duckdb{}, for example, \tool{} improves semantic validity from \sedar{}'s 0.365 to 0.748 by preserving target-compatible schema, type, and function semantics during transfer.
...
\begin{table}[ht]
\centering % <--- 关键：居中对齐
\caption{Comparison of syntactic correctness and semantic validity across target DBMSs. Syn. and Sem. denote syntactic correctness and semantic validity, respectively. The best result in each column is highlighted in bold. The last row reports the relative improvement of \tool{} over \sedar{}.}
...
The semantic improvement is particularly pronounced on DBMSs with larger dialect gaps. On Virtuoso, \tool{} achieves a semantic validity of 0.629, which represents a 272\% improvement over \sedar{}. Consistently, on MonetDB, the semantic validity reaches 0.776, effectively doubling the performance of \sedar{} with a 100\% increase. Even on DuckDB, where \sedar{} performs relatively better, \tool{} still provides a 105\% boost in semantic validity. 
...
In other words, compared to \sedar{}, \tool{} covers 411 more functions, 34 more data types, and 496 more keywords.
...
\resizebox{\columnwidth}{!}{%
        ...
        No translation & 107 & 29 & 235 & 28 & 16 & 102 & 185 & 34 & 291 & 83 & 36 & 124 & 403 & 115 & 752 \\
        SQLGlot & 113 & 25 & 231 & 32 & 15 & 107 & 195 & 28 & 288 & 103 & 35 & 142 & 443 & 103 & 768 \\
        jOOQ & 110 & 17 & 210 & 34 & 14 & 103 & 187 & 22 & 253 & 94 & 34 & 104 & 425 & 87 & 670 \\
        CrackSQL & 133 & 23 & 255 & 41 & 17 & 108 & 198 & 32 & 329 & 146 & 46 & 136 & 518 & 118 & 828 \\
        RISE & 145 & 27 & 236 & 45 & 18 & 122 & 251 & 34 & 314 & 155 & 54 & 160 & 596 & 133 & 832 \\
        \sedar{} & 132 & 29 & 244 & 52 & 17 & 136 & 214 & 39 & 340 & 227 & 61 & 152 & 625 & 146 & 872 \\
        \tool{} & \textbf{161} & \textbf{29} & \textbf{370} & \textbf{87} & \textbf{24} & \textbf{335} & \textbf{456} & \textbf{63} & \textbf{476} & \textbf{332} & \textbf{64} & \textbf{187} & \textbf{1036} & \textbf{180} & \textbf{1368} \\ \midrule
        vs. \sedar{} & +22\% & +0\% & +52\% & +67\% & +41\% & +146\% & +113\% & +62\% & +40\% & +46\% & +5\% & +23\% & +66\% & +23\% & +57\% \\ \bottomrule
        \end{tabular}
}
\end{table}
...
\begin{answerbox}
\textbf{Answer to RQ3:} \tool{} achieves the strongest validity results across all tested translation methods and DBMSs. It improves semantic correctness by up to 272\% over \sedar{} and preserves 1,036 distinct functions, 411 more than \sedar{}. By eliminating semantic hallucinations and employing constructive instantiation, \tool{} ensures generated seeds are both executable and rich in testing logic.
\end{answerbox}
...
\begin{answerbox}
\textbf{Answer to RQ4:} All components are critical: $\tool{}_{\textit{abs}}$ improves syntactic correctness by 37\%, $\tool{}_{\textit{rag}}$ boosts semantic validity by 21\%, and $\tool{}_{\textit{full}}$ improves syntax/semantics by 44\%/38\%. The sanitizer further increases branch coverage by up to 39\%.
\end{answerbox}
