...
DBMS fuzzing relies on mutating initial seed queries into new ones to explore state space and trigger crash bugs, making the quality and diversity of the initial seeds critical.
In practice, many DBMSs, especially emerging engines, lack comprehensive test suites that can serve as high-quality seeds.
