...
% into new ones
DBMS fuzzing relies on mutating initial seed queries to explore state space and trigger crash bugs, making the quality and diversity of the initial seeds critical.
Nevertheless, many DBMSs, especially emerging engines, lack comprehensive test suites that can serve as high-quality seeds.
A practical solution is to transfer test cases from mature DBMSs to target systems as initial fuzzing seeds.
...
Specifically, \tool{} first builds an AQT with dialect-independent structure extraction, preserving statement order and cross-statement dependencies.
...
\smallskip
\noindent\textbf{Feedback-Guided Adaptation.}\\
...
\smallskip
\noindent\textbf{Error-Guided Sanitization.}\\
...
\smallskip
\noindent\textbf{Tiered Fallback Strategy.}\\
...
\smallskip
\noindent\textbf{Mutable-Region Annotation.}\\
