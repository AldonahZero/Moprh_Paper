...
\tool{} addresses this challenge by using parsing and execution feedback to repair unsupported constructs through a structure-preserving fallback process.
As shown in Figure~\ref{fig:feedback-driven}, compatible seeds are sanitized, executed in the target DBMS, repaired when necessary, and finally annotated with mutable regions for fuzzing.
