...
\begin{figure*}[t]
  ...
  (2) Dialect-Aware AQT Instantiation. \tool{} uses a task planner to decompose test case transformations and a hybrid knowledge base to guide the LLM, enabling SQL transformation, rule generation, and error correction.
