...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{media/coverage_over_time_griffin_2x2.pdf}
\caption{Coverage growth over time in 24-hour fuzzing campaigns. Griffin denotes the downstream fuzzer with its original seed corpus.}
