...
DBMS fuzzing mutates initial seed test cases to explore state space and trigger crash bugs, making the quality and diversity of the initial seeds critical.
...
However, existing SQL dialect translation techniques primarily focus on statement-level translation and cannot effectively transfer complete test cases for DBMS fuzzing
...
Our key idea is to decouple structural information from SQL syntax via a dialect-independent Abstract Query Template (AQT), enabling test-case-level abstraction and dialect-aware instantiation for target systems.
...
\tool{} uncovers \bugcnt{} previously unknown bugs, including \bugconfirmcnt{} that have been confirmed, with \bugfixcnt{} that have already been fixed.
...
% Moreover, compared with the state-of-the-art seed transforming approach \sedar{}, \tool{} covers 26\% more branches, finds 16 more bugs in 24 hours, and achieves 100\%--272\% higher semantic correctness for transferred seeds.
