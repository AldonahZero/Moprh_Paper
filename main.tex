...
The instantiation respects the dependency order in $\mathcal{G}_{tc}$, the graph representation of $\Delta$: DDL and DML statements are instantiated before queries that depend on them, and the evolving target context is propagated across statements to maintain cross-statement type, reference, and state consistency.
