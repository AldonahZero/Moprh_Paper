...
RISE's statement-level design is especially limited for seed transfer: in SQLite-to-DuckDB, test-case-level transfer raises semantic correctness from 0.314 to 0.776.
