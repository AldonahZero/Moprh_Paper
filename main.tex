...
Recent approaches leverage Large Language Models (LLMs) for cross-dialect translation~\cite{fu2024sedar}~\TODO{add cite}. 
...
Existing SQL transfer systems differ in whether they satisfy the requirements of fuzzing-seed transfer, especially when seed migration must preserve DDL/DML/DQL interactions and cross-statement dependencies.
