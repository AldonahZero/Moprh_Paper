...
However, DBMS fuzzing seeds are full test cases rather than isolated statements: they often contain multiple interdependent statements including DDL, DML, and DQL, and the translated results must remain parsable and mutable by downstream fuzzers.
