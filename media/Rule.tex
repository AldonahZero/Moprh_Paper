...
% ============================================================
% 2. Test-Oriented Skill Execution (Center)
% ============================================================
...
\node[below=0.2cm of llm.north, font=\small\bfseries\sffamily] (llmTitle) {
    \faBrain \quad Test-Oriented Skill Execution
};
...
% 1. Generator -> Translator (Candidate Rule) - From Left-South
\draw[-latex, thick, black!60] (generator.225) -- (translator.north) 
    node[midway, left, font=\tiny, xshift=-2pt] {Candidate Rule};
